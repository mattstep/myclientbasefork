<dl>
	...
	<dd>
		...
		<?php $x = 1; foreach ($invoice->invoice_tax_rates as $invoice_tax_rate) { ?>
		...
		<select name="tax_rate_option[]">
			<option value="1" <?php if ($invoice_tax_rate->tax_rate_option == 1) { ?>selected="selected"<?php } ?>><?php echo $this->lang->line('item_tax_option_1'); ?></option>
			<option value="2" <?php if ($invoice_tax_rate->tax_rate_option == 2) { ?>selected="selected"<?php } ?>><?php echo $this->lang->line('item_tax_option_2'); ?></option>
		</select>
		<?php if ($x > 1) { ?>
