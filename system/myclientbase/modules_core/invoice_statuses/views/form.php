		...
		<div class="section_wrapper">
			...
			<div class="content toggle">
				...
				<dl>
					...
					<dd><input type="text" name="invoice_status" id="invoice_status" value="<?php echo $this->mdl_invoice_statuses->invoice_status; ?>" /></dd>
				</dl>
				<dl>
					...
					<dd>
						<select name="invoice_status_type">
							...
							<option value="<?php echo $key; ?>" <?php if ($this->mdl_invoice_statuses->invoice_status_type == $key) { ?>selected="selected"<?php } ?>><?php echo $value; ?></option>
							<?php } ?>
						</select>
					</dd>
				</dl>
