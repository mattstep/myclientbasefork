					...
					<div class="content toggle">
						...
						<form method="post" action="<?php echo site_url($this->uri->uri_string()); ?>">
							...
							<dl>
								...
								<dd><input type="text" name="hostname" value="<?php echo $this->mdl_setup->hostname; ?>" /></dd>
							</dl>

							<dl>
								<dt><label><?php echo $this->lang->line('database_name'); ?>: </label></dt>
								<dd><input type="text" name="database" value="<?php echo $this->mdl_setup->database; ?>" /></dd>
							</dl>
							...
							<dl>
								...
								<dd><input type="password" name="password" value="<?php echo $this->mdl_setup->password; ?>" /></dd>
							</dl>
