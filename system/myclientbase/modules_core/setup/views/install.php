	...
	<div class="section_wrapper">
		...
		<div class="content toggle">
			...
			<form method="post" action="<?php echo site_url($this->uri->uri_string()); ?>">
				...
				<dd><input type="text" name="first_name" value="<?php echo $this->mdl_setup->first_name; ?>" /></dd>

				<dt><label>* <?php echo $this->lang->line('last_name'); ?>: </label></dt>
				<dd><input type="text" name="last_name" value="<?php echo $this->mdl_setup->last_name; ?>" /></dd>

				<dt><label>* <?php echo $this->lang->line('username'); ?>: </label></dt>
				<dd><input type="text" name="username" value="<?php echo $this->mdl_setup->username; ?>"/></dd>
				...
				<dd><input type="text" name="company_name" value="<?php echo $this->mdl_setup->company_name; ?>"/></dd>

				<dt><label><?php echo $this->lang->line('email_address'); ?></label></dt>
				<dd><input type="text" name="email_address" value="<?php echo $this->mdl_setup->email_address; ?>"/></dd>

				<dt><label><?php echo $this->lang->line('street_address'); ?></label></dt>
				<dd><input type="text" name="address" value="<?php echo $this->mdl_setup->address; ?>"/></dd>

				<dt><label><?php echo $this->lang->line('city'); ?></label></dt>
				<dd><input type="text" name="city" value="<?php echo $this->mdl_setup->city; ?>"/></dd>

				<dt><label><?php echo $this->lang->line('state'); ?></label></dt>
				<dd><input type="text" name="state" value="<?php echo $this->mdl_setup->state; ?>"/></dd>

				<dt><label><?php echo $this->lang->line('zip'); ?></label></dt>
				<dd><input type="text" name="zip" value="<?php echo $this->mdl_setup->zip; ?>"/></dd>

				<dt><label><?php echo $this->lang->line('country'); ?></label></dt>
				<dd><input type="text" name="country" value="<?php echo $this->mdl_setup->country; ?>"/></dd>

				<dt><label><?php echo $this->lang->line('phone_number'); ?></label></dt>
				<dd><input type="text" name="phone_number" value="<?php echo $this->mdl_setup->phone_number; ?>"/></dd>

				<dt><label><?php echo $this->lang->line('mobile_number'); ?></label></dt>
				<dd><input type="text" name="mobile_number" value="<?php echo $this->mdl_setup->mobile_number; ?>"/></dd>

				<dt><label><?php echo $this->lang->line('fax_number'); ?></label></dt>
				<dd><input type="text" name="fax_number" value="<?php echo $this->mdl_setup->fax_number; ?>"/></dd>

				<dt><label><?php echo $this->lang->line('web_address'); ?></label></dt>
				<dd><input type="text" name="web_address" value="<?php echo $this->mdl_setup->web_address; ?>"/></dd>
