	...
	<div class="section_wrapper">
		...
		<div class="content toggle">
			...
			<?php } else { ?>
				...
				<input type="text" name="template_name" id="template_name" value="<?php echo $this->mdl_templates->template_name; ?>" />
				...
				<textarea name="template_content" style="width: 850px; height: 650px;"><?php echo $this->mdl_templates->template_content; ?></textarea>
